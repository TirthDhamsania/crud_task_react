...
const View = () => {
	...
	const handleDelete = (id) => {
		fetch(`http://localhost:3200/user/${id}`, {
			...
			.catch((err) => console.log(err));
			alert("You have successfully deleted your Details.");
		...
		<div>
			<section id="lastpage">
				<div id="search_and_sort">
					...
					<button id="last_dob_button" onClick={() => handleSort("dateOfBirth")}>
						DOB
					</button>
				...
				{show && (
					<div>
						<div id="formfield">
							...
							<button id="submit_button" onClick={handleUpdate}>Submit</button>
						</div>
					</div>
				)}
			</section>
